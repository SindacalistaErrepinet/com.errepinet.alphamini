 ...
 */
public class NoRecordInterrutibleSkill extends ProxySkill {

    private static final String TAG = "NoRecInterrutSkill";

    @Override
    protected void onSkillStart() {
        super.onSkillStart();
        Log.d(TAG, "不录音可打断技能启动 ");
    }

    @Override
    protected void onSkillStop(SkillStopCause skillStopCause) {
        super.onSkillStop(skillStopCause);
        Log.d(TAG, "不录音可打断技能停止："+skillStopCause);
    }

    @Call(path = "/demo_norec_in_skill/startSkill")
